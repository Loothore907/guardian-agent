# Historical handoff archive — September 6

Historical evidence only. Use [the current handoff](handoff.md) for pickup.
Old instructions, remote states and time windows below do not create authority.
