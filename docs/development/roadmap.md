...
| 2026-09-03 | C6 / W25    | Authenticate Linux authority peers and add fail-closed Secret Service credential resolution                        |      N/A |                                                        Not separately captured | ADR-0038; `docs/development/evidence/w25-linux-peer-and-credentials.md`; focused 26-pass/1-skip suite; full local 63 files / 376 tests; active WSL2 Node 24 peer/process probe 2/2                   | Native Ubuntu CI, then protected Linux credential lifecycle and narrow GitHub read/merge                                    |
