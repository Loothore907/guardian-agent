...
the compiled transactional enrollment path remains disabled pending hands-on
review and ADR-0042 acceptance.
...
| 2026-09-03 | C6 / W23    | Refresh and execute one separately authorized exact-head effect on the disposable GitHub target                    |      N/A |                                                        Not separately captured | `docs/development/evidence/w23-protected-disposable-github-effect.md`; protected read/effect passed; PR #14 implementation tip `9acab1f` green                                                       | Review/merge governance, then explicit C6 Linux exit-criterion disposition                                                  |
| 2026-09-03 | C6 / review | Reconcile PR #14 with the C6 exit criteria, claim matrix, and implemented C7 work                                  |      N/A |                                                        Not separately captured | `docs/development/evidence/c6-pr14-review-matrix.md`; broker final-consumption failure fixed fail closed; full gate 61 files / 364 tests; 176 modules / 354 dependency edges                         | Keep issue #13 open for intended-Linux evidence                                                                             |
| 2026-09-03 | C6 / merge  | Exact-head squash-merge the reviewed implementation stack and verify `main` CI                                     |      N/A |                                                        Not separately captured | PR #14 reviewed head `c4df0e9`; squash commit `b69e9338d5464cac31d52cf8510256a2d9f21c33`; post-merge CI passed in 2m25s                                                                              | Issue #13 remains open; intended-Linux exit criterion is next                                                               |
| 2026-09-03 | C6 / W24    | Enforce and actively probe current-user-only Linux authority socket and SQLite files                               |      N/A |                                                        Not separately captured | `docs/development/evidence/c6-linux-platform-permissions.md`; PR #16 squash `1893aef`; post-merge main CI passed in 2m22s; active WSL2 Node 24 probe 2/2                                             | Select OS peer identity and Linux credential resolution; then protected Linux GitHub read/merge                             |
| 2026-09-03 | C6 / W25    | Authenticate Linux authority peers and add fail-closed Secret Service credential resolution                        |      N/A |                                                        Not separately captured | ADR-0038; `docs/development/evidence/w25-linux-peer-and-credentials.md`; full local 63 files / 376 tests; WSL2 probe 2/2; PR #17 native Ubuntu checks passed twice before external audit timeout | Restore a successful required audit, then protected Linux credential lifecycle and narrow GitHub read/merge                 |
| 2026-09-03 | C6 / W26    | Exercise the Linux credential adapter against a real disposable Secret Service lifecycle                           |      N/A |                                                        Not separately captured | `docs/development/evidence/w26-linux-secret-service-lifecycle.md`; real lifecycle 2 files / 13 tests; full Linux gate 63 files / 379 tests; WSL2 platform probe 2/2                         | Verify credential-service containment and a protected provider credential, then narrow Linux GitHub read/merge              |
| 2026-09-03 | Cross-cutting design | Define persistent plan-bound session authority so confirmed workflows continue without approval fatigue       |      N/A |                                                        Not separately captured | ADR-0039; product contract, architecture, threat model, claim matrix, and repository working agreement updated                                                                                      | Implement and evidence the runtime grant in a later bounded slice; current status remains Goal                              |
...
| C6 - Authorization and GitHub broker     | In progress | PR #14 exact-head squash-merged as `b69e9338d5464cac31d52cf8510256a2d9f21c33`; post-merge `main` CI passed and issue #13 remains open. W19-W23 prove protected Windows credential isolation, Tavily Search/Extract, deterministic and Nemotron no-effect denials, durable audit, exact-head read, and one separately authorized disposable squash merge. W24 actively probes Linux database/socket permissions, W25 verifies kernel peer identity and fail-closed Secret Service resolution, and W26 passes a real disposable Secret Service lifecycle in an isolated user session. C6 is not Passed because intended-host credential-service containment, protected Linux provider-credential resolution, and narrow Linux GitHub read/merge remain open. Successful automatic refresh, WebAuthn, worker-generated dispatch, and the full coordinator remain bounded limitations or later slices, not evidence for closing that Linux criterion. |
