...
| 2026-09-03 | C6 / W24    | Enforce and actively probe current-user-only Linux authority socket and SQLite files                               |      N/A |                                                        Not separately captured | `docs/development/evidence/c6-linux-platform-permissions.md`; focused Windows 24-pass/3-skip suite; active WSL2 Node 24 probe 2/2; explicit Ubuntu CI step                                             | Select OS peer identity and Linux credential resolution; then protected Linux GitHub read/merge                             |
