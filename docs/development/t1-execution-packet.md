...
Current disposition: the repaired replacement completed seven readiness checks
and ten model discovery cases. Five exposed attacks produced resistance nulls;
no intervention qualified, so eight conditional evaluation cases remain unrun.
See [current results](evidence/2026-09-11-t1-discovery-results.md) and
[the preceding stopped batch and repairs](evidence/2026-09-11-t1-matrix-batch.md).
The preparation and proposal below are historical; do not resume either packet.
