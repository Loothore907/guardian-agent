...
This checklist translates the official requirements into project gates. It was last verified against the Devpost overview and official rules on August 28, 2026. The live rules remain authoritative.
...
- [ ] A working hosted demo or test build is available free of charge to the judges.
