...
mkdir -p "$sandbox_root/dev" "$sandbox_root/etc" "$sandbox_root/proc" \
  "$sandbox_root/tmp" "$sandbox_root/usr" "$sandbox_root/workspace"
...
cp -- "$probe_source" "$sandbox_root/workspace/reference-probe.py"
chmod 0555 "$sandbox_root/workspace/reference-probe.py"
